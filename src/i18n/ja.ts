...
export const ja: Translations = {
  ...
  guru_philosophy_druckenmiller:
    "• マクロ取引の巨区：通貨、金利、株式の相関関係を分析した方向性ベット。クォンタム・ファンドでスタートし約30年間年平均～30%\n" +
    "• ソロスの直弟子：クォンタム・ファンドで証明済みの通貨・金利戦略を継承・発展。'92年ポンドショートなど大型マクロベットわ成功\n" +
    "• 集中ベット：「确信があるなら、常に弱点を目指すべきだ」。目下の最高のアイデアに資産の大部分を投じる\n" +
    "• モメンタム追従：トレンドに乗り、シグナルが変れば即座に転換。プライドより利益を優先\n" +
    "• 非対称リスク管理：損失を限定しながら利益を最大化する非対称ポジション運用\n" +
    "• 名言：「長期リターンを構築する方法は二つだ：資本を守り、ホームランを打て」",
  guru_philosophy_smith:
    "• 優良企業の長期保有：「良い企業を買い、遊びすぎず、何もしない(Buy good companies, don't overpay, do nothing)」\n" +
    "• 高いROIC重視：投下資本利益率が高く持続可能な企業にのみ投資。ROIC 20%未満は興味なし\n" +
    "• 集中ポートフォリオ：約 25～30銘柄で構成。「分散投資はリスク軽減ではなく、無知の表れ」\n" +
    "• 品質優先：割安より企業品質を重視。割高でも優良企業なら長期保有\n" +
    "• 複利効果：優れた企業が創出するキャッシュフローを高収益率で自己再投資する複利メカニズム\n" +
    "• 名言：「リスク軽減のために分散するという考え方には問題がある。投資するなら最高の企業だけを持て」",
  guru_philosophy_greenblatt:
    "• 魔法の公式：高い益回り(Earnings Yield)と高い投資資本利益率(ROIC)の組み合わせ\n" +
    "• 定量的バリュー投資：感情を排した体系的・ルールベースの投資アプローチ。「市場を打ち負かす小さな本」に体系化\n" +
    "• 見遠された銘柄の発掘：市場が無視した割安優良企業を体系的に選別\n" +
    "• 分散投資：20～30銘柄に分散し個別銘柄リスクを低減\n" +
    "• 忍耐が必須：「魔法の公式はほとんどの期間で機能するが、時に3～4年間市場に遅れることもある」\n" +
    "• 名言：「『何か』の価値を見極め、それよりまったく安く買え。株式市場は短期的にはミスターマーケットだ」",
