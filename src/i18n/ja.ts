...
export const ja: Translations = {
  ...
  about_tagline: "資産統合管理 + AI・投資グルインサイト",
  about_intro:
    "Portfolio Bridgeは日本・米国・韓国・ドイツなどの多国籍金融資産を1つのダッシュボードで一元管理し、AIと伝説の投資グルたちの視点からポートフォリオの洞察を得られるprivacy-firstウェブアプリです。すべてのデータはブラウザ内のみに保存され、外部サーバーに送信されることはありません。",
  about_features_title: "主な機能",
  about_feat1_title: "統合ダッシュボード",
  about_feat1_desc:
    "主要KPIサマリー、銘柄別損益ランキングチャート、資産推移グラフ、カテゴリー・通貨別配分分析およびリバランス提案を一目で確認できます。",
  about_feat2_title: "多国籍資産 & 非課税・節税口座",
  about_feat2_desc:
    "Yahoo Finance銘柄検索と多国籍証券口座（NISA成長/つみたて投資枠、特定口座、一般口座、iDeCo、年金貯蓄など）を細分化して統合管理。AI自動分類、CSVインポート・エクスポート対応。",
  about_feat3_title: "投資グル23名 & 6種クオンツ分析",
  about_feat3_desc:
    "バフェット、ダリオ、リンチなど23名の投資哲学・ポートフォリオと比較し、リンチ10バガー・グリーンブラット魔法公式・グレアム防御的投資・スミスクオリティ・ピオトロスキーFスコア・オニールCAN SLIMの6種クオンツ採点機およびFREDバフェット指数で銘柄を多角的に分析できます。",
  about_feat4_title: "AIポートフォリオ診断",
  about_feat4_desc:
    "グルペルソナと税制効率的なアセット・ロケーション（資産配置）指針を組み込んだ専用AIプロンプトを生成。ChatGPT、Claude、Gemini、Grokにそのまま貼り付けて高度な助言を受けられます。",
  about_feat5_title: "自動リスクインサイト",
  about_feat5_desc:
    "集中リスク、大きな損失、現金不足、為替リスクなどを自動検知し、即座に対処可能なリスク管理アドバイスを提供します。",
  about_feat6_title: "多言語・多通貨",
  about_feat6_desc:
    "日本語・English・한국어・Deutschの4言語と、KRW・USD・JPY・EURのリアルタイム為替レートに基づく通貨表示に対応。",
  about_feat7_title: "FIRE早期リタイアプランナー",
  about_feat7_desc:
    "安全な引き出し率と期待複利利回りに基づき、いつ経済的自立（FIRE）を達成できるかのインタラクティブな成長ロードマップをシミュレーションします。",
  about_privacy_title: "プライバシーファースト & クラウド同期",
  about_privacy_desc:
    "すべての資産データはブラウザのlocalStorageのみに安全に保存され、アカウント登録不要で即座にご利用いただけます。任意でGoogle Driveと連携し、デバイス間の安全なバックアップ・復元も可能です。",
  ...
  dash_notice_mobile:
    "💡 モバイル・タブレット・デスクトップの全画面サイズに対応したレスポンシブレイアウトで提供されています。",
  ...
  guru_detail_explorer_label: "巨匠を探す",
  ...
  guru_ai_scope_title: "相談対象の銘柄選択",
  guru_ai_scope_desc: "投資グルに分析を依頼する保有銘柄を選択・除外できます。",
  guru_ai_scope_count: (selected, total) => `${selected}/${total}件選択中`,
  guru_ai_scope_reset: "デフォルトに戻す",
  guru_ai_scope_select_all: "すべて選択",
  guru_ai_scope_deselect_all: "選択解除",
  guru_ai_scope_empty_warning: "相談プロンプトを生成するには、最低1件以上の銘柄を選択してください。",
  guru_all_scoped_out_notice: "現在すべての資産が「ダッシュボード専用」または「非表示」に設定されているため、デフォルトの相談対象銘柄がありません。グルを選択後、バナーから相談に含める銘柄を選択してください。",

  // ─── Custom Guru ──────────────────────────────────────────────────────────
  custom_guru_dash_banner_title: "カスタムAIグル診断",
  custom_guru_dash_banner_desc: "目標配分と投資傾向に合わせた1対1の詳細ポートフォリオ相談",
  custom_guru_dash_banner_action: "診断を受ける",
  custom_guru_selector_badge: "カスタムグル",
  custom_guru_default_name: "私のカスタムグル",
  custom_guru_unconfigured_desc: "投資傾向と目標配分を設定して独自のAIアドバイザーを作成しましょう",
  custom_guru_settings_btn: "ペルソナ設定",
  custom_guru_modal_title: "カスタムAIグルの設定",
  custom_guru_modal_desc: "リスク許容度、戦略スタイル、助言トーンを組み合わせて専属AIアドバイザーを作成します。",
  custom_guru_name_label: "グルの名称 / 称号",
  custom_guru_icon_label: "代表アイコン",
  custom_guru_risk_label: "リスク許容度",
  custom_guru_risk_conservative: "安定志向 (元本保全・下落耐性重視)",
  custom_guru_risk_balanced: "バランス型 (市場連動・着実な複利運用)",
  custom_guru_risk_aggressive: "積極投資型 (高成長・アルファ追求)",
  custom_guru_strategy_label: "投資戦略スタイル",
  custom_guru_strat_all_weather: "オールウェザー (経済サイクル分散)",
  custom_guru_strat_dividend: "配当＆キャッシュフロー (インカム・再投資)",
  custom_guru_strat_tech: "革新技術＆未来成長 (ビッグテック・AI)",
  custom_guru_strat_value: "ディープバリュー (安全域・割安株)",
  custom_guru_strat_momentum: "クオンツ＆モメンタム (体系的ファクター)",
  custom_guru_tone_label: "助言トーン",
  custom_guru_tone_direct: "率直・辛口型 (マンガー流、過度な投機を厳しく指摘)",
  custom_guru_tone_mentor: "温かいメンター型 (ボーグル/リンチ流、忍耐と励まし)",
  custom_guru_tone_quant: "客観的アナリスト型 (ダリオ流、確率とデータ重視)",
  custom_guru_philosophy_label: "投資原則・メモ (任意)",
  custom_guru_philosophy_placeholder: "例：暗号資産の売却は提案しないこと、現金比率15%を維持",
  custom_guru_target_preview_label: "ポートフォリオ目標資産配分",
  custom_guru_target_help: "ダッシュボードの「分類 目標 vs 実績」と連携し、AI投資家の評価基準になります。",
  custom_guru_target_edit_btn: "目標配分を変更",
  custom_guru_target_empty: "目標配分が未設定です。[目標配分を変更]ボタンから設定してください。",
  custom_guru_save_btn: "保存して適用",
  custom_guru_reset_btn: "初期値に戻す",
  custom_guru_cancel_btn: "キャンセル",

  // ─── Guru Guide & Strategy Tags ──────────────────────────────────────────
  guru_tag_value: "バリュー投資",
  guru_tag_growth: "成長・モメンタム",
  guru_tag_passive: "資産配分・パッシブ",
  guru_tag_quant: "クオンツ・規律",
  guru_tag_macro: "マクロ・トレンド",
  guru_tag_hedge: "逆張り・ヘッジ",

  guru_filter_all: "すべて",
  guru_search_placeholder: "投資家名・ファンド名で検索...",
  guru_search_clear: "検索をクリア",
  guru_search_empty: "条件に一致する投資家が見つかりません。",
  guru_count_badge: (count: number) => `${count}名を表示`,
  guru_btn_all_grid: "全体一覧",

  guru_guide_btn: "おすすめ診断",
  guru_guide_modal_title: "投資スタイル別おすすめ診断",
  guru_guide_modal_desc: "3つの簡単な質問に答えるだけで、あなたの投資スタイルに最適な巨匠をご提案します。",
  guru_guide_step: (current: number, total: number) => `ステップ ${current} / ${total}`,
  guru_guide_q1_title: "Q1. 投資で最も重視する目標とリスク許容度は？",
  guru_guide_q1_opt_conservative: "元本保全と安定配当（下落リスクの回避を最優先）",
  guru_guide_q1_opt_balanced: "市場平均を上回るバランス成長（適度な変動を許容）",
  guru_guide_q1_opt_aggressive: "市場を圧倒するハイリターン追求（大きな変動を許容）",
  guru_guide_q2_title: "Q2. 好みのポートフォリオ運用アプローチは？",
  guru_guide_q2_opt_value: "本質的価値と安全域を重視（バリュー投資）",
  guru_guide_q2_opt_growth: "破壊的イノベーションとモメンタム（成長株）",
  guru_guide_q2_opt_passive: "全天候型の資産配分とインデックス（パッシブ）",
  guru_guide_q2_opt_quant: "明確なデータ指標と実証済みの規律（クオンツ）",
  guru_guide_q2_opt_macro: "マクロ経済サイクルとトレンド追随（グローバル・マクロ）",
  guru_guide_q2_opt_hedge: "暴落やテールリスクに備える逆張りヘッジ",
  guru_guide_q3_title: "Q3. どのようなアドバイスのトーンを希望しますか？",
  guru_guide_q3_opt_mentor: "温かく励ましてくれるメンター型",
  guru_guide_q3_opt_blunt: "率直で厳しい現実を突きつける直言型",
  guru_guide_q3_opt_academic: "論理的かつ学究的で原理原則を説く型",
  guru_guide_q3_opt_trader: "鋭い相場観を持つ機敏な実践勝負師型",
  guru_guide_q3_opt_trader_desc: "機敏なモメンタムと市場トレンド重視",

  guru_guide_result_title: "あなたに最適な投資家のご提案",
  guru_guide_result_desc: "ご回答いただいた投資スタイルに基づき、最も相性の良い巨匠を導き出しました。",
  guru_guide_result_best_badge: "ベストマッチ",
  guru_guide_result_score: "一致度",
  guru_guide_result_select_btn: "この投資家と相談する",
  guru_guide_result_other_matches: "その他の候補",
  guru_guide_result_candidate_select: "選択",
  guru_guide_result_custom_prompt: "オリジナルの投資家を作成したいですか？",
  guru_guide_result_custom_link: "自分だけのAI投資家を設定する",
  guru_guide_btn_next: "次へ",
  guru_guide_btn_prev: "前へ",
  guru_guide_btn_restart: "もう一度診断する",

  guru_match_reason_buffett: "企業の持続的な経済の堀、安全域、そして元本保全を最優先する長期バリュー投資に最適です。",
  guru_match_reason_munger: "マンガーの逆転思考と冷徹なファクトチェックにより、投資の致命的なミスを排除します。",
  guru_match_reason_lynch: "身近な生活から成長企業を発掘し、バランスの取れた成長と適正株価を両立させます。",
  guru_match_reason_graham: "純流動資産と徹底した安全域を重視する、堅実な防衛的バリュー投資に適しています。",
  guru_match_reason_dalio: "あらゆる経済環境や危機にも耐えうる、全天候型（オールウェザー）の分散投資に最適です。",
  guru_match_reason_bogle: "市場平均への投資とコスト最小化を徹底する、恒久的なインデックス投資の王道です。",
  guru_match_reason_swensen: "株式中心のグローバル多資産分散と体系的なリバランスを目指す投資家に最適です。",
  guru_match_reason_taleb: "予期せぬブラックスワンに備え、非対称なダウンサイドヘッジで資産を守り抜きます。",
  guru_match_reason_wood: "世界を変革する破壊的イノベーション技術と急成長の可能性に賭ける投資家に適しています。",
  guru_match_reason_soros: "市場の再帰性とマクロ経済サイクルの歪みを鋭く捉える勝負師の視点を提供します。",
  guru_match_reason_greenblatt: "資本利益率（ROC）と益回りを組み合わせた魔法の公式によるクオンツ投資に適しています。",
  guru_match_reason_marks: "市場サイクルの二次的思考と、不確実な局面におけるリスク制御に長けたメンターです。",
  guru_match_reason_category_value: "本質的価値より割安な優良資産を発掘し、長期的な複利成長を享受する王道の哲学です。",
  guru_match_reason_category_growth: "高い成長モメンタムと革新的なビジネスモデルにより、市場平均を上回るリターンを狙います。",
  guru_match_reason_category_passive: "体系的な多資産分散と規律あるリバランスで、ボラティリティを抑え着実に増やします。",
  guru_match_reason_category_quant: "主観や感情を排し、検証された財務指標と統計的ルールに基づいて冷静に判断します。",
  guru_match_reason_category_macro: "世界の金利、流動性、景気サイクルの大局を読み、機敏にポートフォリオを適応させます。",
  guru_match_reason_category_hedge: "極端な市場危機や暴落に備え、非対称なヘッジで資産を堅固に守ります。",
  ...
  guru_name_bogle: "ジョン・ボーグル",
  guru_name_swensen: "デビッド・スウェンセン",
  guru_name_taleb: "ナシム・タレブ",
  ...
  guru_philosophy_dalio:
    ...
    "• 非負債資産ヘッジ：債務サイクル末期と財政赤字に備え、債券を減らし金（10〜15%）やビットコインなどの非負債資産で分散防衛\n" +
  ...
  guru_quotes_dalio:
    ...
    "自分が知らないことを知ることは、自分が知っているどんなことよりも遥かに重要である",
  ...
  guru_quotes_lilu:
    ...
    "一生のうちに本当に優れた投資アイデアはほんの数個あれば十分だ",
  ...
  guru_quotes_ackman:
    ...
    "シンプルで予測可能であり、圧倒的な市場地位と価格決定力を持つ優良企業を保有せよ",
  ...
  guru_quotes_fisher:
    ...
    "短期的なヘッドラインはノイズに過ぎず、長期的な富の原動力は資本主義の革新である",
  ...
  guru_philosophy_marks:
    ...
    "• 激変（Sea Change）：超低金利時代が終わり正常金利環境が到来したことで、高利回りの信用/債券資産が株式に匹敵する魅力的なリターンを提供\n" +
  ...
  guru_quotes_marks:
    ...
    "環境が変われば戦略も変わらなければならない。私たちは激変（Sea Change）の時代に生きている",
  ...
  guru_quotes_klarman:
    ...
    "私たちの目標は金を稼ぐことではなく、金を失わないことだ。そうすれば利益はおのずとついてくる\n" +
    "市場は常に間違う可能性があり、価格変動がそのままリスクを意味するわけではない",
  ...
  guru_quotes_wood:
    ...
    "破壊的イノベーションに投資する際は、短期的な変動を恐れず5年の技術Sカーブを見据えよ",

  guru_philosophy_druckenmiller:
    "• マクロ運用の名手：マクロ経済、金融政策、金利、株式の相関関係を洞察し、確信が持てた時に巨大な方向性ポジションを構築\n" +
    "• ビットコイン＆インフラ：ビットコインの価値保存ブランドを認め、AIデータセンターおよびマイニング電力インフラの非対称な上方にベット\n" +
  ...
  guru_quotes_druckenmiller:
    ...
    "市場を当てることよりも重要なのは、絶大な確信がある時に勝負をかける勇気である",
  guru_philosophy_smith:
    "• 優良企業の長期保有：「良い企業を買い、買い過ぎず、何もしない（Buy good companies, don't overpay, do nothing）」という核心原則\n" +
    "• 高ROCE重視：資本を再投資し持続的に高い利益を生む、強固な堀を持つ資本軽量（Capital-light）企業を選別\n" +
    "• AI過剰CapExへの警戒：ビッグテックによる無秩序なAIインフラ軍備競争が、企業の資本収益率とフリーキャッシュフローを毀損しないか厳格に監視\n" +
    "• 集中ポートフォリオ：市場収益率を食い潰す過度な分散を拒否し、約20〜30のコア銘柄にのみ集中してアイデアの質で勝負\n" +
    "• 実践的アクティブ交代：長期保有を基本としつつも、ファンダメンタルズや資本効率が崩れた企業は教条主義に陥らず迅速に売却\n" +
    "• 複利メカニズムと忍耐：内部再投資収益率の高い偉大な企業を長期保有し、複利効果を最大化\n",
  guru_quotes_smith:
    "良い企業を買い、買い過ぎず、何もしない（Buy good companies, don't overpay, do nothing）\n" +
  ...
  guru_philosophy_bogle:
    "• インデックス革命: すべての株式を所有せよ。市場平均を上回ろうとする試みは、結局は手数料のせいで失敗する。\n" +
    "• コストの最小化: 投資リターンを蝕む運用手数料、売買回転率、税金を容赦なくコントロールせよ。\n" +
    "• 航路を守れ(Stay the Course): 市場の短期的なノイズや暴落に揺さぶられず、自分が決めた資産配分を最後まで維持せよ。\n" +
    "• 複利の魔法: 複利の利息は投資における最大の奇跡だが、複利のコストは最も恐ろしい災難である。\n" +
    "• シンプルさの美学: 複雑なファンドやデリバティブの代わりに、低コストの広範なインデックスファンド一つで十分だ。\n",
  guru_quotes_bogle:
    "干し草の山から針を探そうとするな、干し草の山全体を買え。\n" +
    "時間はあなたの友人であり、衝動はあなたの敵である。\n" +
    "投資の最大の敵はコストと感情である。市場全体を買い、航路を守り続けよ。",
  guru_philosophy_swensen:
    "• 基金モデル(Endowment Model): 伝統的な株式・債券の構成を超え、代替資産（プライベートエクイティ、不動産、コモディティ）に大規模に分散投資せよ。\n" +
    "• 株式中心のポートフォリオ: 長期的な購買力を維持するため、期待収益率の高い株式的な資産の比率を高めよ。\n" +
    "• 真の分散: 互いに相関関係の低い資産クラスを組み合わせることで、リターンを損なうことなくポートフォリオのリスクを根本的に低下させよ。\n" +
    "• 非流動性プレミアム: 直ちに現金化する必要のない長期資金であれば、流動性を放棄する代わりにより高いリターン（非流動性プレミアム）を得よ。\n" +
    "• 機械的リバランス: 市場が揺れ動く時に感情に流されず、価格が上がった資産を売り、下がった資産を買うリバランスを厳格に執行せよ。\n",
  guru_quotes_swensen:
    "分散投資は投資における唯一のフリーランチである。\n" +
    "投資家の最大の敵は、常に投資家自身である。\n" +
    "長期的な投資成果の90%以上は、個別銘柄の選択ではなく資産配分の構造によって決まる。",
  guru_philosophy_taleb:
    "• バーベル戦略: 中程度のレベルのリスクを避け、極めて安全な資産(90%)と極めて危険な資産(10%)の両極端に資本を配分せよ。\n" +
    "• アンチフラジャイル(反脆さ): 衝撃や無秩序に耐えるだけでなく、むしろその混沌の中でより強くなり収益を上げるポジションを構築せよ。\n" +
    "• ブラックスワンへの備え: 金融モデルが予測できない極端で破壊的な例外事象が発生した時に、破産しないことが最も重要である。\n" +
    "• 脆弱性と投機排除: 本質的価値のない投機的流行資産（Bitcoin Black Paper）の脆弱性を厳格に警戒せよ。\n" +
    "• 非対称な報酬の追求: プットオプションや現物コモディティなど、下方リスクが限定され上方ポテンシャルが無限の場所に賭けよ。\n",
  guru_quotes_taleb:
    "生存がすべてに優先する。破産してはならない、そうでなければ長期的なリターンも存在しない。\n" +
    "風はろうそくの火を消すが、炎をより燃え上がらせる。炎になれ。\n" +
    "生き残れない壊滅的リスクを冒すことは投資ではなく、自殺である。",
  ...
  settings_target_section_desc: "資産カテゴリごとの目標配分比率を設定します。合計は100%である必要があります。",
  settings_target_sum: (n) => `合計: ${n}%`,
  settings_target_save: "保存",
  settings_target_saved: "保存しました",
  settings_data_title: "データバックアップと管理",
  settings_data_local_auto_note:
    "すべてのポートフォリオデータはブラウザのローカルストレージ（localStorage）にリアルタイムで自動保存されます。",
  settings_data_local_title: "ローカルストレージ初期化",
  settings_data_desc:
  ...
  at_col_ticker: "ティッカー",
  at_col_visibility: "表示範囲",
  at_filter_all_visibility: "すべての表示範囲",
  at_filter_all_account: "すべての口座",
  filter_select_all: "すべて選択",
  ...
  history_range_1m: "1ヶ月",
  history_range_3m: "3ヶ月",
  history_range_6m: "6ヶ月",
  history_range_1y: "1年",
  history_range_all: "全期間",
  history_all_portfolio_badge: "全ポートフォリオ基準",
  ...
  pnl_sort_abs: "絶対値順",
  pnl_sort_profit: "利益順",
  pnl_sort_return: "リターン順",
  pnl_show_top20: "上位20件",
  pnl_show_all: (count) => `全件表示 (${count})`,
  pnl_summary_win_loss: (win, loss) => `利益 ${win} · 損失 ${loss}`,
  ...
  af_visibility_label: "表示範囲",
  af_visibility_help: "ダッシュボードおよび投資グルAI相談への包含を設定します。",
  ...
  broker_type_none: "指定なし",
  broker_type_custom: "直接入力...",
  broker_type_custom_placeholder: "口座種別を直接入力 (例: 法人, つみたて専用など)",
  ...
  broker_delete_inline_confirm: "本当に削除しますか？",
  broker_confirm_btn: "確認",
  ...
  fire_kpi_target_amount: "目標資産",
  fire_kpi_total_contributions: "総貯蓄元本",
  fire_kpi_compound_growth: "複利運用益",
  fire_kpi_years_to_fire: "FIRE達成",
  fire_kpi_already_achieved: "目標達成済み 🎉",
  fire_preset_conservative: "保守的 (4%)",
  fire_preset_moderate: "標準 (7%)",
  fire_preset_aggressive: "積極的 (10%)",
  fire_kpi_compound_leverage: "複利レバレッジ効果",
  fire_kpi_compound_ratio: (ratio) => `+${ratio}% 複利創出`,
  fire_kpi_years_suffix: (years) => `${years}年後`,
  fire_age_reached_badge: (age) => `${age}歳到達`,
  fire_already_reached_desc: "現在の資産が目標金額を達成しており、今すぐ経済的自由を享受できます。",
  fire_age_unit: "歳",
  fire_swr_preset_conservative: "3.5% (保守的)",
  fire_swr_preset_trinity: "4.0% (トリニティ)",
  fire_swr_preset_aggressive: "5.0% (積極的)",
  settings_data_drive_subtitle: "Google Drive クラウドバックアップ",
  fire_chart_title: "予測資産成長推移",
  fire_chart_asset: "予測資産額",
  fire_chart_target: "目標額",
  fire_chart_milestone: "FIRE達成年",
  ...
  visibility_labels: {
    all: "すべて表示",
    dashboard_only: "ダッシュボード限定",
    guru_only: "AI診断限定",
    hidden: "非表示",
  },
  visibility_descriptions: {
    all: "ダッシュボードと投資グルAI相談の両方に含まれます。",
    dashboard_only: "ダッシュボードにのみ表示され、投資グルAI相談からは除外されます。",
    guru_only: "投資グルAI相談にのみ含まれ、ダッシュボード集計からは除外されます。",
    hidden: "ダッシュボードと投資グルAI相談の両方から除外されます。",
  },
};
