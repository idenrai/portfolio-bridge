...
export const ja: Translations = {
  ...
  about_feat3_desc:
    "バフェット、ダリオ、リンチなど伝説の投資家23名の哲学と代表ポートフォリオを参考に、自分のポートフォリオと比較できます。リンチ10バガー・グリーンブラット魔法公式・グレアム防御的投資・スミスクオリティ・ピオトロスキーFスコア・オニールCAN SLIMの6種採点機で銘柄を分析。グルペルソナAIプロンプトも提供します。",
