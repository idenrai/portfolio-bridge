...
export const ko: Translations = {
  ...
  about_feat3_desc:
    "버핏 · 달리오 · 린치 등 23명의 투자 철학과 대표 포트폴리오를 참고해 내 포트폴리오와 비교할 수 있습니다. 린치 10루타 · 그린블라트 마법공식 · 그레이엄 방어투자 · 스미스 퀄리티 · 피오트로스키 F-Score · 오닐 CAN SLIM 6종 채점기로 종목을 분석하고, 구루 페르소나 AI 프롬프트를 제공합니다.",
