...
export const ko: Translations = {
  ...
  about_intro:
    "Portfolio Bridge는 한국 · 미국 · 일본 · 독일 등 다국가 금융자산을 하나의 대시보드에서 통합 관리하고, AI와 전설적인 투자 구루들의 관점에서 포트폴리오 인사이트를 얻을 수 있는 privacy-first 웹 앱입니다. 모든 데이터는 브라우저 내에만 저장되며 외부 서버로 전송되지 않습니다.",
  about_features_title: "주요 기능",
  about_feat1_title: "통합 대시보드",
  about_feat1_desc:
    "핵심 KPI 요약, 종목별 손익 랭킹 차트, 자산 구성 추이, 카테고리/통화별 배분 분석 및 리밸런싱 제안을 한눈에 확인하세요.",
  about_feat2_title: "다국가 자산 & 절세 계좌",
  about_feat2_desc:
    "Yahoo Finance 종목 검색 및 다국가 증권 계좌(NISA 성장/적립, ISA, 연금저축, IRP, 일반과세 등)를 세분화하여 통합 관리합니다. AI 자동 분류, CSV 가져오기 · 내보내기 지원.",
  about_feat3_title: "투자 구루 23인 & 퀀트 채점기",
  about_feat3_desc:
    "버핏 · 달리오 · 린치 등 23인의 투자 철학과 포트폴리오를 비교하고, 린치 10루타 · 그린블라트 마법공식 · 그레이엄 방어투자 · 스미스 퀄리티 · 피오트로스키 F-Score · 오닐 CAN SLIM 6종 퀀트 채점기 및 FRED 버핏 지수로 종목을 다각도로 분석합니다.",
  about_feat4_title: "AI 포트폴리오 진단",
  about_feat4_desc:
    "구루 페르소나와 세무 효율적 자산 배치(Asset Location) 지침이 결합된 맞춤형 AI 프롬프트를 생성합니다. ChatGPT, Claude, Gemini 등에 바로 붙여넣어 깊이 있는 자문을 받아보세요.",
  about_feat5_title: "자동 인사이트",
  about_feat5_desc:
    "과대 비중, 큰 손실, 현금 부족, 환 노출 초과 등을 자동으로 감지해 즉각적인 알림과 리스크 관리 조언을 제공합니다.",
  about_feat6_title: "다국어 · 다통화",
  about_feat6_desc:
    "한국어 · English · 日本語 · Deutsch 4개국어와 KRW · USD · JPY · EUR 실시간 환율 기반 통화 변환을 지원합니다.",
  about_feat7_title: "FIRE 조기은퇴 플래너",
  about_feat7_desc:
    "안전 인출률과 기대 복리 수익률을 기반으로 언제 경제적 자유(FIRE)에 도달할 수 있는지 인터랙티브 성장 로드맵을 시뮬레이션합니다.",
  about_privacy_title: "프라이버시 퍼스트 & 클라우드 백업",
  about_privacy_desc:
    "모든 자산 데이터는 브라우저 localStorage에만 안전하게 저장되며 회원가입 없이 즉시 사용 가능합니다. 선택적으로 Google Drive를 연동하여 기기 간 안전한 백업 및 동기화를 지원합니다.",
  ...
  dash_notice_mobile:
    "💡 모바일과 데스크톱 모든 환경에서 반응형 레이아웃으로 최적화되어 제공됩니다.",
  ...
  guru_detail_explorer_label: "거장 탐색",
  ...
  guru_ai_scope_title: "상담 포함 종목 선택",
  guru_ai_scope_desc: "구루에게 분석을 요청할 보유 종목을 선택하거나 제외할 수 있습니다.",
  guru_ai_scope_count: (selected, total) => `${selected}/${total}개 선택됨`,
  guru_ai_scope_reset: "기본값으로 복원",
  guru_ai_scope_select_all: "전체 선택",
  guru_ai_scope_deselect_all: "전체 해제",
  guru_ai_scope_empty_warning: "최소 1개 이상의 종목을 선택해야 구루 상담 프롬프트를 생성할 수 있습니다.",
  guru_all_scoped_out_notice: "현재 모든 자산이 '대시보드 전용' 또는 '숨김'으로 설정되어 있어 기본 상담 대상 종목이 없습니다. 구루를 선택한 후 상단 배너에서 상담에 포함할 종목을 직접 선택할 수 있습니다.",

  // ─── Custom Guru ──────────────────────────────────────────────────────────
  custom_guru_dash_banner_title: "나만의 맞춤형 AI 구루 진단",
  custom_guru_dash_banner_desc: "내 목표 배분과 투자 성향에 맞춘 1:1 심층 포트폴리오 상담",
  custom_guru_dash_banner_action: "진단받기",
  custom_guru_selector_badge: "나만의 구루",
  custom_guru_default_name: "나만의 맞춤 구루",
  custom_guru_unconfigured_desc: "성향과 목표 배분을 설정하여 나만의 AI 어드바이저를 완성하세요",
  custom_guru_settings_btn: "구루 성향 설정",
  custom_guru_modal_title: "나만의 AI 구루 설정",
  custom_guru_modal_desc: "투자 위험 성향, 추구 전략, 조언 어투를 조합하여 나만의 전속 AI 어드바이저를 만듭니다.",
  custom_guru_name_label: "구루 호칭 / 이름",
  custom_guru_icon_label: "대표 아이콘",
  custom_guru_risk_label: "투자 위험 성향",
  custom_guru_risk_conservative: "안정 추구형 (방어 및 원금 보존)",
  custom_guru_risk_balanced: "균형 성장형 (시장 추종 및 안정 복리)",
  custom_guru_risk_aggressive: "적극 수익형 (고성장 및 알파 추구)",
  custom_guru_strategy_label: "투자 전략 스타일",
  custom_guru_strat_all_weather: "올웨더 자산배분 (경제 사계절 대비)",
  custom_guru_strat_dividend: "배당 & 현금흐름 (인컴 및 재투자)",
  custom_guru_strat_tech: "혁신 기술 & 미래성장 (빅테크/AI)",
  custom_guru_strat_value: "딥 밸류 가치투자 (안전마진 및 저평가)",
  custom_guru_strat_momentum: "퀀트 & 모멘텀 (체계적 팩터/추세)",
  custom_guru_tone_label: "조언 어투 (코칭 톤)",
  custom_guru_tone_direct: "냉철한 팩트폭격형 (멍거 스타일, 과도한 투기 직설 경고)",
  custom_guru_tone_mentor: "따뜻한 장기투자 멘토형 (보글/린치 스타일, 인내와 격려)",
  custom_guru_tone_quant: "객관적인 데이터 분석가형 (달리오 스타일, 확률과 통계)",
  custom_guru_philosophy_label: "나만의 투자 원칙 / 메모 (선택)",
  custom_guru_philosophy_placeholder: "예: 코인은 매도 권유하지 말 것, 현금 비중 15% 항상 유지",
  custom_guru_target_preview_label: "포트폴리오 목표 자산 배분",
  custom_guru_target_help: "대시보드의 '분류 목표 vs 실제'와 연동되어 맞춤 구루의 진단 벤치마크로 활용됩니다.",
  custom_guru_target_edit_btn: "목표 배분 수정",
  custom_guru_target_empty: "등록된 목표 배분이 없습니다. [목표 배분 수정] 버튼을 눌러 설정해 주세요.",
  custom_guru_save_btn: "저장하고 구루 적용",
  custom_guru_reset_btn: "기본값 복원",
  custom_guru_cancel_btn: "취소",

  // ─── Guru Guide & Strategy Tags ──────────────────────────────────────────
  guru_tag_value: "가치투자",
  guru_tag_growth: "성장·모멘텀",
  guru_tag_passive: "자산배분·패시브",
  guru_tag_quant: "퀀트·공식",
  guru_tag_macro: "매크로·추세",
  guru_tag_hedge: "역발상·헤지",

  guru_filter_all: "전체",
  guru_search_placeholder: "구루 이름 또는 운용사 검색...",
  guru_search_clear: "검색어 지우기",
  guru_search_empty: "검색 조건에 일치하는 구루가 없습니다.",
  guru_count_badge: (count: number) => `${count}명 표시`,
  guru_btn_all_grid: "전체 목록",

  guru_guide_btn: "나에게 맞는 구루 찾기",
  guru_guide_modal_title: "투자 성향 맞춤 구루 추천 가이드",
  guru_guide_modal_desc: "간단한 3가지 질문에 답변하시면 내 성향과 자산 목표에 가장 잘 부합하는 역사적 거장을 찾아드립니다.",
  guru_guide_step: (current: number, total: number) => `단계 ${current} / ${total}`,
  guru_guide_q1_title: "Q1. 투자에서 가장 중시하는 목표와 위험 성향은?",
  guru_guide_q1_opt_conservative: "원금 보존과 안정적 배당 복리 (하락 방어 최우선)",
  guru_guide_q1_opt_balanced: "시장 평균을 웃도는 균형 복리 성장 (적정 변동성 수용)",
  guru_guide_q1_opt_aggressive: "시장을 압도하는 파괴적 고수익 추구 (높은 변동성 감수)",
  guru_guide_q2_title: "Q2. 선호하는 포트폴리오 운용 접근법은?",
  guru_guide_q2_opt_value: "기업 내재가치와 충분한 안전마진 중심 (가치투자)",
  guru_guide_q2_opt_growth: "혁신적인 미래 성장주와 시장 모멘텀 (성장주)",
  guru_guide_q2_opt_passive: "경제 사계절을 견디는 자산배분과 인덱스 (올웨더/패시브)",
  guru_guide_q2_opt_quant: "명확한 데이터 지표와 검증된 공식 규칙 (퀀트)",
  guru_guide_q2_opt_macro: "거시경제 사이클과 글로벌 유동성 추세 (글로벌 매크로)",
  guru_guide_q2_opt_hedge: "폭락장과 꼬리 위험을 방어하는 역발상 헤지 (블랙스완/안전)",
  guru_guide_q3_title: "Q3. 구루에게 기대하는 조언의 어투는?",
  guru_guide_q3_opt_mentor: "따뜻하고 상냥하며 격려해 주는 멘토형",
  guru_guide_q3_opt_blunt: "솔직하고 냉철하며 뼈를 때리는 직설형",
  guru_guide_q3_opt_academic: "논리적이고 학구적인 원칙과 철학 설명형",
  guru_guide_q3_opt_trader: "시장 감각이 날카롭고 기민한 실전 승부사형",
  guru_guide_q3_opt_trader_desc: "기민한 모멘텀 및 시장 흐름 중시",

  guru_guide_result_title: "당신을 위한 맞춤 구루 추천 결과",
  guru_guide_result_desc: "답변하신 투자 성향과 지표를 바탕으로 가장 높은 적합도를 보인 거장들입니다.",
  guru_guide_result_best_badge: "최고의 매칭",
  guru_guide_result_score: "일치율",
  guru_guide_result_select_btn: "이 구루와 상담 시작하기",
  guru_guide_result_other_matches: "기타 추천 후보",
  guru_guide_result_candidate_select: "선택",
  guru_guide_result_custom_prompt: "원하는 구루를 직접 만들고 싶으신가요?",
  guru_guide_result_custom_link: "나만의 맞춤 구루 설정하기",
  guru_guide_btn_next: "다음",
  guru_guide_btn_prev: "이전",
  guru_guide_btn_restart: "다시 진단하기",

  guru_match_reason_buffett: "기업의 지속적인 해자와 안전마진, 원금 보존을 최우선으로 삼는 장기 가치투자에 가장 적합합니다.",
  guru_match_reason_munger: "멍거의 다학제적 역발상 지혜와 냉철한 팩트 체크로 포트폴리오의 실수를 방어합니다.",
  guru_match_reason_lynch: "생활 속에서 발견하는 확실한 실적 성장주와 균형 잡힌 가치 성장에 적합합니다.",
  guru_match_reason_graham: "순유동자산과 철저한 안전마진을 지키는 정통 방어적 가치투자에 부합합니다.",
  guru_match_reason_dalio: "어떤 경제 위기에도 흔들리지 않는 글로벌 올웨더 분산투자에 최적입니다.",
  guru_match_reason_bogle: "시장 타이밍을 배제하고 비용을 극소화하는 영구 패시브 인덱스 복리에 부합합니다.",
  guru_match_reason_swensen: "주식 중심의 글로벌 자산배분과 체계적 리밸런싱을 지향하는 투자자에게 적합합니다.",
  guru_match_reason_taleb: "예측할 수 없는 블랙스완에 대비해 취약성을 제거하고 안티프래질을 추구합니다.",
  guru_match_reason_wood: "세상을 바꿀 파괴적 혁신 기술과 고성장 잠재력에 집중하는 투자자에게 어울립니다.",
  guru_match_reason_soros: "시장 반사성과 거시경제 사이클의 불균형을 예리하게 포착하는 매크로 승부사입니다.",
  guru_match_reason_greenblatt: "자본수익률(ROC)과 이익수익률의 기계적 마법공식 퀀트 투자에 적합합니다.",
  guru_match_reason_marks: "시장 사이클의 2차적 사고와 경기 국면별 리스크 통제에 최적화된 멘토입니다.",
  guru_match_reason_category_value: "내재가치 대비 저평가된 우량 자산을 발굴하여 장기 복리를 누리는 정통 가치투자 철학입니다.",
  guru_match_reason_category_growth: "고성장 모멘텀과 혁신적인 비즈니스 모델을 바탕으로 시장 초과수익을 창출합니다.",
  guru_match_reason_category_passive: "체계적인 다자산 분산투자와 리밸런싱으로 변동성을 낮추고 안정적인 복리를 달성합니다.",
  guru_match_reason_category_quant: "주관적 감정을 배제하고 검증된 통계 지표와 데이터 규칙에 따라 냉철하게 판단합니다.",
  guru_match_reason_category_macro: "글로벌 금리, 유동성, 경기 사이클의 큰 흐름을 읽고 기민하게 대응합니다.",
  guru_match_reason_category_hedge: "극단적인 시장 위기와 폭락장에 대비하여 포트폴리오의 비대칭 안전마진을 구축합니다.",
  ...
  guru_name_bogle: "존 보글",
  guru_name_swensen: "데이비드 스웬슨",
  guru_name_taleb: "나심 탈레브",
  ...
  guru_quotes_lynch:
    ...
    "주식 시장에서 가장 중요한 신체 기관은 뇌가 아니라 위장(배짱)이다.\n" +
  ...
  guru_philosophy_dalio:
    ...
    "• 비부채 자산 헤지: 부채 사이클 말기와 정부 재정적자에 대비해 채권을 줄이고 금(10~15%)과 비트코인 등 비부채 자산으로 분산 방어\n" +
  ...
  guru_quotes_dalio:
    ...
    "당신이 모르는 것을 아는 것이, 당신이 아는 그 어떤 것보다 훨씬 중요하다.",
  ...
  guru_quotes_lilu:
    ...
    "평생 동안 진정으로 위대한 투자 아이디어는 몇 개만 있으면 충분하다.",
  ...
  guru_quotes_ackman:
    ...
    "지배적인 시장 지위와 강력한 가격 결정력을 가진 단순하고 예측 가능한 우량 기업을 소유하라.",
  ...
  guru_quotes_burry:
    ...
    "대중의 광기 속에서 조용히 내재가치와 숨겨진 꼬리위험을 계산하라.",
  ...
  guru_quotes_fisher:
    ...
    "단기적인 헤드라인은 대개 소음일 뿐이며, 장기적인 부의 진정한 원동력은 자본주의의 혁신이다.",
  ...
  guru_quotes_cohen:
    ...
    "거래의 핵심 전제가 깨졌다면 감정을 버리고 즉시 손실을 끊어내라.",
  guru_philosophy_marks:
    ...
    "• 상전벽해(Sea Change): 초저금리 시대가 끝나고 정상 금리 환경이 도래함에 따라, 고수익 신용/채권 자산이 주식에 필적하는 매력적인 수익을 제공\n" +
  ...
  guru_quotes_marks:
    ...
    "환경이 변하면 전략도 변해야 한다. 우리는 상전벽해(Sea Change)의 시대에 살고 있다.",
  ...
  guru_quotes_wood:
    ...
    "파괴적 혁신 기업에 투자할 때는 단기 변동성에 흔들리지 말고 5년의 기술 S-곡선을 보아야 한다.",

  guru_philosophy_druckenmiller:
    "• 매크로 트레이딩 거장: 통화, 금리, 주식 간의 상관관계 분석을 통한 강력한 방향성 베팅\n" +
    "• 비트코인 & 인프라: 비트코인의 가치 저장소 브랜드를 인정하고, AI 데이터센터 및 채굴 전력 인프라의 비대칭 상방 잠재력에 베팅\n" +
    "• 확신에 대한 집중 베팅: 거래에 대해 확신이 설 때는 과감하게 최대 규모로 집중 투자\n" +
    "• 모멘텀과 유연성: 추세를 타되 신호가 반전되면 자존심을 버리고 즉시 방향을 전환\n" +
    "• 비대칭 위험 관리: 손실은 철저히 제한하면서 비대칭적 포지션 사이징으로 수익을 극대화\n",
  guru_quotes_druckenmiller:
    "장기적으로 압도적인 수익률을 만드는 길은 철저한 자본 보전과 이따금씩 치는 거대한 홈런이다.\n" +
    "계란을 한 바구니에 담아라. 그리고 그 바구니를 밤낮없이 아주 철저하게 지켜보라.\n" +
    "시장을 맞히는 것보다 중요한 것은, 절대적인 확신이 있을 때 크게 베팅할 줄 아는 용기다.",
  guru_philosophy_smith:
    "• 우량 기업 장기 보유: '좋은 기업을 사고, 비싸게 사지 말고, 아무것도 하지 마라(Buy good companies, don't overpay, do nothing)'라는 핵심 원칙\n" +
    "• 높은 ROCE 중시: 자본을 재투자해 지속적으로 높은 수익을 창출하는 독점적 해자를 가진 자본경량(Capital-light) 기업 선별\n" +
    "• AI 과잉 CapEx 경계: 빅테크의 무분별한 AI 인프라 군비경쟁이 기업의 자본수익률과 잉여현금흐름을 훼손하는지 엄격히 감시\n" +
    "• 집중 포트폴리오: 시장 수익률을 갉아먹는 과도한 분산을 거부하고 약 20~30개 핵심 종목에만 집중해 아이디어의 질로 승부\n" +
    "• 실용적 액티브 교체: 장기 보유를 지향하되 펀더멘털이나 자본효율이 훼손된 기업은 교조주의에 빠지지 않고 신속히 매도\n" +
    "• 복리 메커니즘과 인내: 내부 재투자 수익률이 높은 위대한 기업을 장기 보유하여 시간의 복리 효과를 극대화\n",
  guru_quotes_smith:
    "좋은 기업을 사고, 너무 비싸게 사지 말고, 아무것도 하지 마라(Buy good companies, don't overpay, do nothing).\n" +
  ...
  guru_philosophy_bogle:
    "• 인덱스 혁명: 모든 주식을 소유하라. 시장 평균을 이기려는 시도는 결국 수수료로 인해 실패한다.\n" +
    "• 비용 최소화: 투자 수익을 갉아먹는 운용 수수료, 매매 회전율, 세금을 무자비하게 통제하라.\n" +
    "• 항해 유지(Stay the Course): 시장의 단기적 소음이나 폭락에 흔들리지 말고, 자신이 정한 자산 배분을 끝까지 유지하라.\n" +
    "• 복리의 마법: 복리의 이자는 투자의 가장 위대한 기적이지만, 복리의 비용은 가장 끔찍한 재앙이다.\n" +
    "• 단순함의 미학: 복잡한 펀드나 파생상품 대신, 저비용 광범위 인덱스 펀드 하나만으로 충분하다.\n",
  guru_quotes_bogle:
    "건초더미에서 바늘을 찾으려 하지 말고, 건초더미 전체를 사라.\n" +
    "시간은 당신의 친구이고, 충동은 당신의 적이다.\n" +
    "투자의 최대 적은 비용과 감정이다. 단순한 인덱스 펀드를 사서 영원히 항해를 지속하라.",
  guru_philosophy_swensen:
    "• 기금 모델(Endowment Model): 전통적인 주식/채권 구성을 넘어, 대체 자산(사모펀드, 부동산, 원자재)에 대규모로 분산 투자하라.\n" +
    "• 주식 중심 포트폴리오: 장기적인 구매력 유지를 위해 기대 수익률이 높은 주식 성격의 자산에 비중을 높여라.\n" +
    "• 진정한 분산: 서로 상관관계가 낮은 자산군들을 결합하여, 수익률을 훼손하지 않고 포트폴리오의 리스크를 근본적으로 낮춰라.\n" +
    "• 비유동성 프리미엄: 당장 현금화할 필요가 없는 장기 자금이라면, 유동성을 포기하는 대신 더 높은 수익(비유동성 프리미엄)을 취하라.\n" +
    "• 기계적 리밸런싱: 시장이 요동칠 때 감정에 휩쓸리지 않고, 가격이 오른 자산을 팔고 내린 자산을 사는 리밸런싱을 엄격히 집행하라.\n",
  guru_quotes_swensen:
    "분산 투자는 투자의 유일한 공짜 점심이다.\n" +
    "투자자의 가장 큰 적은 언제나 투자자 자신이다.\n" +
    "장기적인 포트폴리오 성과의 90% 이상은 개별 종목 선택이 아니라 자산 배분 구조에서 결정된다.",
  guru_philosophy_taleb:
    "• 바벨(Barbell) 전략: 중간 위험을 피하고 90% 초안전 자산과 10% 극단적 비대칭 위험자산으로 분배\n" +
    "• 안티프래질(Antifragile): 충격과 혼란에 단순 견디는 것을 넘어, 혼란으로부터 더 강해지고 이익을 얻는 구조 설계\n" +
    "• 블랙스완 대비: 금융 모델이 예측하지 못하는 극단적 사건이 발생해도 절대 파산하지 않는 생존 최우선주의\n" +
    "• 취약성과 폰지 배제: 내재가치와 펀더멘털이 없는 투기적 유행 자산(Bitcoin Black Paper)의 취약성을 엄격히 경계\n" +
    "• 비대칭 보상 추구: 하방 손실은 엄격히 제한되지만 상방 잠재력은 극대화되는 풋옵션 및 실물 헤지 베팅\n",
  guru_quotes_taleb:
    "생존이 모든 것에 우선한다. 파산하지 않아야 장기적인 수익도 존재한다.\n" +
    "바람은 촛불을 끄지만, 불꽃은 더 타오르게 한다. 불꽃이 되어라.\n" +
    "자신이 감당할 수 없는 파멸의 위험을 안고 베팅하는 것은 투자가 아니라 자살이다.",
  ...
  settings_target_section_desc: "포트폴리오 자산 분류별 목표 비중을 설정합니다. 합계는 100%여야 합니다.",
  settings_target_sum: (n) => `합계: ${n}%`,
  settings_target_save: "저장",
  settings_target_saved: "저장되었습니다",
  settings_data_title: "데이터 백업 및 관리",
  settings_data_local_auto_note:
    "모든 포트폴리오 데이터는 브라우저 로컬 저장소(localStorage)에 실시간으로 자동 보관됩니다.",
  settings_data_local_title: "로컬 스토리지 초기화",
  ...
  at_col_ticker: "티커",
  at_col_visibility: "표시 범위",
  at_filter_all_visibility: "모든 표시 범위",
  at_filter_all_account: "모든 계좌",
  filter_select_all: "전체 선택",
  filter_clear_all: "전체 해제",
  ...
  history_range_1m: "1개월",
  history_range_3m: "3개월",
  history_range_6m: "6개월",
  history_range_1y: "1년",
  history_range_all: "전체",
  history_all_portfolio_badge: "전체 포트폴리오 기준",
  ...
  pnl_sort_abs: "절댓값순",
  pnl_sort_profit: "수익순",
  pnl_sort_return: "수익률순",
  pnl_show_top20: "상위 20개",
  pnl_show_all: (count) => `전체 보기 (${count})`,
  pnl_summary_win_loss: (win, loss) => `수익 ${win} · 손실 ${loss}`,
  ...
  af_visibility_label: "표시 범위",
  af_visibility_help: "대시보드 및 구루 AI 상담 포함 여부를 설정합니다.",
  ...
  broker_type_none: "선택 안 함 (미지정)",
  broker_type_custom: "직접 입력...",
  broker_type_custom_placeholder: "계좌 종류 직접 입력 (예: 공모주전용, 법인 등)",
  ...
  broker_delete_inline_confirm: "정말 삭제할까요?",
  broker_confirm_btn: "확인",
  ...
  fire_kpi_target_amount: "목표 자산",
  fire_kpi_total_contributions: "총 저축 원금",
  fire_kpi_compound_growth: "복리 창출 수익",
  fire_kpi_years_to_fire: "FIRE 달성",
  fire_kpi_already_achieved: "즉시 달성 완료 🎉",
  fire_preset_conservative: "보수적 (4%)",
  fire_preset_moderate: "중립적 (7%)",
  fire_preset_aggressive: "공격적 (10%)",
  fire_kpi_compound_leverage: "복리 레버리지 효과",
  fire_kpi_compound_ratio: (ratio) => `+${ratio}% 복리 창출`,
  fire_kpi_years_suffix: (years) => `${years}년 후`,
  fire_age_reached_badge: (age) => `${age}세 도달`,
  fire_already_reached_desc: "현재 자산이 목표 금액을 충족하여 즉시 경제적 자유를 누리실 수 있습니다.",
  fire_age_unit: "세",
  fire_swr_preset_conservative: "3.5% (보수적)",
  fire_swr_preset_trinity: "4.0% (트리니티)",
  fire_swr_preset_aggressive: "5.0% (적극적)",
  settings_data_drive_subtitle: "Google Drive 클라우드 백업",
  fire_chart_title: "예상 자산 성장 추이",
  fire_chart_asset: "예상 자산액",
  fire_chart_target: "목표액",
  fire_chart_milestone: "FIRE 달성 시점",
  ...
  visibility_labels: {
    all: "전체 표시",
    dashboard_only: "대시보드 전용",
    guru_only: "구루 전용",
    hidden: "숨김",
  },
  visibility_descriptions: {
    all: "대시보드와 구루 AI 상담에 모두 포함됩니다.",
    dashboard_only: "대시보드에만 표시되며, 구루 AI 상담에서 제외됩니다.",
    guru_only: "구루 AI 상담에만 포함되며, 대시보드 집계에서 제외됩니다.",
    hidden: "대시보드와 구루 AI 상담 모두에서 제외됩니다.",
  },
};
