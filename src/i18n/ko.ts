...
export const ko: Translations = {
  ...
  guru_philosophy_taleb:
    "• 바벨 전략(Barbell Strategy): 중간 수준의 위험을 피하고, 극도로 안전한 자산(90%)과 극도로 위험한 자산(10%)에 양극화하여 투자하라.\n" +
    "• 안티프래질(Antifragile): 충격이나 무질서를 견디는 것을 넘어, 오히려 그 혼돈 속에서 더 강해지고 수익을 내는 포지션을 구축하라.\n" +
    "• 블랙 스완 대비: 금융 모델이 예측하지 못하는 극단적이고 파괴적인 예외 사건(Black Swan)이 발생했을 때 파산하지 않는 것이 가장 중요하다.\n" +
    "• 비대칭적 보상 추구: 잃을 수 있는 금액(하방 리스크)은 철저히 제한되어 있지만, 벌 수 있는 금액(상방 잠재력)은 무한한 곳에 베팅하라.\n" +
    "• 전문가에 대한 회의: 월스트리트의 은행가, 학자, 예측 모델을 맹신하지 말고, 스스로의 생존을 책임지는 리스크 관리에 집중하라.\n",
  guru_quotes_taleb:
