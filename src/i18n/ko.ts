...
export const ko: Translations = {
  ...
  guru_top_holdings_title: (name) => `${name}의 대표 보유 종목 (Top 5)`,
  guru_holdings_col_ticker: "티커",
  guru_holdings_col_name: "종목명",
  guru_holdings_col_weight: "비중",
  guru_holdings_note:
    "※ 공시 자료 및 공개 정보 기반의 대표 종목이며, 실시간 보유 현황과 다를 수 있습니다.",
  ...
  guru_philosophy_druckenmiller:
    "• 매크로 트레이딩의 달인: 통화, 금리, 주식 간 상관관계를 분석하여 방향성 베팅\n" +
    "• 소로스의 수제자: 퀀텀 펀드에서 검증된 통화·금리 투자 전략을 계승·발전\n" +
    "• 집중 베팅: 최고의 아이디어에 자산의 상당 부분을 과감하게 베팅\n" +
    "• 모멘텀 추종: 추세가 있는 방향으로 오르되, 신호가 바뀌면 즉각 전환\n" +
    "• 비대칭 리스크 관리: 손실을 제한하면서 수익을 극대화하는 비대칭 포지션 운용",
  guru_philosophy_smith:
    "• 우량 기업 장기 보유: '좋은 기업을 사고 아무것도 하지 말라'는 단순한 철학\n" +
    "• 높은 ROIC 중시: 자본 수익률이 높고 지속 가능한 기업에만 투자\n" +
    "• 집중 포트폴리오: ~25개 종목으로 구성된 집중형 포트폴리오 유지\n" +
    "• 품질 우선: 저평가보다 품질에 집중, 비싸더라도 좋은 기업이면 매수\n" +
    "• 복리 효과: 뛰어난 기업이 스스로 창출한 현금 흐름이 재투자되는 복리 메커니즘",
  guru_philosophy_greenblatt:
    "• 마법 공식(Magic Formula): 이익수익률(Earnings Yield)과 자본수익률(ROIC)이 높은 종목을 체계적으로 선별\n" +
    "• 정량적 가치 투자: 감정을 배제한 체계적·규칙 기반의 투자 접근\n" +
    "• 소외된 주식 발굴: 시장이 무시한 저평가 우량 기업을 체계적으로 선별\n" +
    "• 분산 투자: 20~30개 종목에 분산하여 개별 종목 리스크 감소\n" +
    "• 인내가 필수: '마법 공식은 대부분 기간에 작동하지만, 가끔 3~4년 시장에 뒤처질 수도 있다'",
