...
export const ko: Translations = {
  ...
  guru_philosophy_munger:
    ...
    "• 유행 아이디어 회피: 대중적 서사와 군중 사고에 휩쓸리지 말고, 진정한 독립적 판단을 최우선으로\n" +
  ...
  buffett_indicator_loading: "FRED 데이터 불러오는 중…",
  ...
  buffett_indicator_source: "출처: FRED (Federal Reserve Bank of St. Louis) · Wilshire 5000 / GDP",
