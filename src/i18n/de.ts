...
export const de: Translations = {
  ...
  about_tagline: "Einheitliche Vermögensverwaltung + KI & Guru-Einblicke",
  about_intro:
    "Portfolio Bridge ist eine datenschutzorientierte Web-App zur ganzheitlichen Verwaltung internationaler Finanzanlagen (Korea, USA, Japan, Deutschland) in einem Dashboard, ergänzt durch Portfolio-Einblicke von KI und legendären Investment-Gurus. Alle Daten verbleiben ausschließlich in Ihrem Browser.",
  about_features_title: "Hauptfunktionen",
  about_feat1_title: "Einheitliches Dashboard",
  about_feat1_desc:
    "Wichtige KPI-Kennzahlen, P&L-Ranglisten-Wasserfalldiagramme, historische Portfolioentwicklung, Kategorie- & Währungsallokation sowie Rebalancing-Vorschläge auf einen Blick.",
  about_feat2_title: "Internationale Vermögenswerte & Steueroptimierte Depots",
  about_feat2_desc:
    "Verwalten Sie weltweite Bestände und differenzierte Depottypen (NISA, ISA, Rentensparen, IRP, Standarddepot usw.) mit Yahoo Finance-Suche, KI-Klassifizierung und CSV-Import/Export.",
  about_feat3_title: "23 Investment-Gurus & 6 Quant-Scorer",
  about_feat3_desc:
    "Vergleichen Sie Ihre Anlagen mit den Philosophien von 23 Investoren-Ikonen (Buffett, Dalio, Lynch etc.) und bewerten Sie Titel mit 6 quantitativen Scorern (Lynch, Magic Formula, Graham, Smith, Piotroski, O'Neil) plus FRED Buffett-Indikator (^W5000 / BIP).",
  about_feat4_title: "KI-Portfoliodiagnose",
  about_feat4_desc:
    "Generieren Sie strukturierte KI-Prompts mit Guru-Personas und steuereffizienten Asset-Location-Direktiven zur direkten Nutzung in ChatGPT, Claude, Gemini oder Grok.",
  about_feat5_title: "Automatische Risiko-Einblicke",
  about_feat5_desc:
    "Erkennt automatisch Klumpenrisiken, hohe Verluste, Liquiditätsengpässe und übermäßige Fremdwährungsrisiken mit praktischen Hinweisen zur Risikominderung.",
  about_feat6_title: "Mehrsprachig & Mehrwährungsfähig",
  about_feat6_desc:
    "Vollständige Benutzeroberfläche auf Deutsch, Englisch, Koreanisch und Japanisch mit Echtzeit-Währungsumrechnung zwischen KRW, USD, JPY und EUR.",
  about_feat7_title: "FIRE-Frühruhestandsplaner",
  about_feat7_desc:
    "Simulieren Sie den Zinseszinseffekt Ihres Portfolios und ermitteln Sie Ihren genauen Meilenstein zur finanziellen Unabhängigkeit (FIRE) auf Basis sicherer Entnahmeraten.",
  about_privacy_title: "Datenschutz an erster Stelle & Cloud-Backup",
  about_privacy_desc:
    "Alle Daten werden sicher im localStorage Ihres Browsers ohne Registrierung gespeichert. Optional können Sie Google Drive für sichere Backups und geräteübergreifende Synchronisation anbinden.",
  ...
  dash_notice_mobile:
    "💡 Vollständig responsiv und für Mobilgeräte, Tablets und Desktops optimiert.",
  ...
  guru_detail_explorer_label: "Gurus entdecken",
  ...
  // ─── Custom Guru ──────────────────────────────────────────────────────────
  custom_guru_dash_banner_title: "Mein individueller KI-Guru",
  custom_guru_dash_banner_desc: "1:1 detaillierte Portfolio-Beratung passend zu Ihren Zielen und Risikoprofil",
  custom_guru_dash_banner_action: "Beraten lassen",
  custom_guru_selector_badge: "Mein Guru",
  custom_guru_default_name: "Mein individueller Guru",
  custom_guru_unconfigured_desc: "Konfigurieren Sie Stil und Ziele für Ihren persönlichen KI-Berater",
  custom_guru_settings_btn: "Persona anpassen",
  custom_guru_modal_title: "Eigenen KI-Guru konfigurieren",
  custom_guru_modal_desc: "Kombinieren Sie Risikotoleranz, Strategie und Tonfall für Ihren persönlichen Berater.",
  custom_guru_name_label: "Name / Titel des Gurus",
  custom_guru_icon_label: "Avatar-Symbol",
  custom_guru_risk_label: "Risikotoleranz",
  custom_guru_risk_conservative: "Konservativ (Kapitalerhalt & Absicherung)",
  custom_guru_risk_balanced: "Ausgewogen (Marktrendite & stetes Wachstum)",
  custom_guru_risk_aggressive: "Offensiv (Hohes Wachstum & Alpha-Maximierung)",
  custom_guru_strategy_label: "Anlagestrategie",
  custom_guru_strat_all_weather: "Allwetter (Makro-Diversifikation)",
  custom_guru_strat_dividend: "Dividende & Cashflow (Einkommen & Zinseszins)",
  custom_guru_strat_tech: "Tech & Innovation (Wachstum & Zukunft)",
  custom_guru_strat_value: "Deep Value (Sicherheitsmarge & Bewertung)",
  custom_guru_strat_momentum: "Quant & Momentum (Systematische Faktoren)",
  custom_guru_tone_label: "Tonfall der Beratung",
  custom_guru_tone_direct: "Direkt & Schonungslos (Munger-Stil: ehrliche Fakten)",
  custom_guru_tone_mentor: "Unterstützender Mentor (Bogle/Lynch-Stil: geduldig & ermutigend)",
  custom_guru_tone_quant: "Objektiver Analyst (Dalio-Stil: datenbasiert & analytisch)",
  custom_guru_philosophy_label: "Persönliche Anlageprinzipien (Optional)",
  custom_guru_philosophy_placeholder: "z.B. Krypto nicht verkaufen, mindestens 15% Cash halten",
  custom_guru_target_preview_label: "Portfolio-Zielallokation",
  custom_guru_target_help: "Synchronisiert mit Dashboard 'Kategorie-Ziel vs. Ist' als Benchmark für den AI-Guru.",
  custom_guru_target_edit_btn: "Zielallokation bearbeiten",
  custom_guru_target_empty: "Keine Ziel-Allokation konfiguriert. Klicken Sie auf [Zielallokation bearbeiten].",
  custom_guru_save_btn: "Speichern & Anwenden",
  custom_guru_reset_btn: "Zurücksetzen",
  custom_guru_cancel_btn: "Abbrechen",

  // ─── Guru Guide & Strategy Tags ──────────────────────────────────────────
  guru_tag_value: "Value Investing",
  guru_tag_growth: "Wachstum & Momentum",
  guru_tag_passive: "Asset Allocation",
  guru_tag_quant: "Quant & Regeln",
  guru_tag_macro: "Global Macro",
  guru_tag_hedge: "Antizyklisch & Hedge",

  guru_filter_all: "Alle",
  guru_search_placeholder: "Name oder Fonds suchen...",
  guru_search_clear: "Suche löschen",
  guru_search_empty: "Keine Gurus entsprechen Ihren Kriterien.",
  guru_count_badge: (count: number) => `${count} Gurus angezeigt`,
  guru_btn_all_grid: "Alle Gurus",

  guru_guide_btn: "Passenden Guru finden",
  guru_guide_modal_title: "Persönlicher Guru-Finder",
  guru_guide_modal_desc: "Beantworten Sie 3 kurze Fragen, um die Investoren-Legende zu finden, die am besten zu Ihrer Strategie passt.",
  guru_guide_step: (current: number, total: number) => `Schritt ${current} von ${total}`,
  guru_guide_q1_title: "Q1. Was ist Ihr primäres Anlageziel und Risikotoleranz?",
  guru_guide_q1_opt_conservative: "Kapitalerhalt & stetige Dividenden (Kapitalschutz zuerst)",
  guru_guide_q1_opt_balanced: "Ausgewogenes Wachstum über dem Marktdurchschnitt",
  guru_guide_q1_opt_aggressive: "Aggressive Überrendite mit hoher Dynamik (hohe Volatilität akzeptiert)",
  guru_guide_q2_title: "Q2. Welcher Portfolioansatz spricht Sie am meisten an?",
  guru_guide_q2_opt_value: "Innerer Wert, Burggräben & Sicherheitsmarge (Value Investing)",
  guru_guide_q2_opt_growth: "Disruptive Innovationen & Marktmomentum (Wachstum)",
  guru_guide_q2_opt_passive: "Allwetter-Multi-Asset-Allokation & Indexing (Passiv)",
  guru_guide_q2_opt_quant: "Systematische Finanzdaten & bewährte Formeln (Quant)",
  guru_guide_q2_opt_macro: "Globale Liquiditätszyklen & Makrotrends (Global Macro)",
  guru_guide_q2_opt_hedge: "Tail-Risk Absicherung & antizyklischer Schutz (Hedge)",
  guru_guide_q3_title: "Q3. Welchen Beratungston bevorzugen Sie?",
  guru_guide_q3_opt_mentor: "Warmherzig, ermutigend und unterstützend",
  guru_guide_q3_opt_blunt: "Direkt, schonungslos und ehrlich",
  guru_guide_q3_opt_academic: "Intellektuell fundiert, prinzipientreu und akademisch",
  guru_guide_q3_opt_trader: "Agil, scharfsinnig und markterfahren",
  guru_guide_q3_opt_trader_desc: "Fokus auf agile Dynamik und Markttrends",

  guru_guide_result_title: "Ihre empfohlenen Investmentgurus",
  guru_guide_result_desc: "Basierend auf Ihren Angaben passen diese Legenden am besten zu Ihrem Profil.",
  guru_guide_result_best_badge: "BESTER MATCH",
  guru_guide_result_score: "Übereinstimmung",
  guru_guide_result_select_btn: "Mit diesem Guru beraten",
  guru_guide_result_other_matches: "Weitere Empfehlungen",
  guru_guide_result_candidate_select: "Auswählen",
  guru_guide_result_custom_prompt: "Möchten Sie einen eigenen Mentor erstellen?",
  guru_guide_result_custom_link: "Eigenen Custom-Guru konfigurieren",
  guru_guide_btn_next: "Weiter",
  guru_guide_btn_prev: "Zurück",
  guru_guide_btn_restart: "Erneut testen",

  guru_match_reason_buffett: "Ideal für langfristige Anleger, die auf dauerhafte Burggräben, Cashflow und Werterhalt setzen.",
  guru_match_reason_munger: "Nutzen Sie Mungers Inversionsmodell und schonungslose Logik, um teure Fehler zu vermeiden.",
  guru_match_reason_lynch: "Entdecken Sie solide Wachstumsaktien aus dem Alltag mit pragmatischer PEG-Disziplin.",
  guru_match_reason_graham: "Perfekt für defensive Value-Investoren, die auf Substanzwerte und Sicherheitsmargen achten.",
  guru_match_reason_dalio: "Entwickelt für krisenfeste Allwetter-Diversifikation über alle Wirtschaftsphasen hinweg.",
  guru_match_reason_bogle: "Der Goldstandard für kostengünstiges, dauerhaftes Indexing ohne Markttiming.",
  guru_match_reason_swensen: "Pionier der institutionellen Stiftungs-Allokation mit diszipliniertem Rebalancing.",
  guru_match_reason_taleb: "Schützen Sie Ihr Vermögen vor Fat-Tail-Krisen durch konvexe Antifragilität.",
  guru_match_reason_wood: "Fokussiert auf exponentielle technologische Transformation und thematisches Wachstum.",
  guru_match_reason_soros: "Nutzt Marktreflexivität und makroökonomische Ungleichgewichte gezielt aus.",
  guru_match_reason_greenblatt: "Systematischer Quant-Ansatz basierend auf der magischen Formel aus ROC und Gewinnrendite.",
  guru_match_reason_marks: "Meistert Marktzyklen, Denken zweiter Ordnung und Risikokontrolle in unsicheren Zeiten.",
  guru_match_reason_category_value: "Fokussiert auf unterbewertete Qualitätsunternehmen für stetigen langfristigen Zinseszins.",
  guru_match_reason_category_growth: "Setzt auf wachstumsstarke Marktführer mit starker Dynamik und Skalierbarkeit.",
  guru_match_reason_category_passive: "Breite Diversifikation und regelbasiertes Rebalancing für stabile Zinseszinseffekte.",
  guru_match_reason_category_quant: "Rationelle Entscheidungen auf Basis geprüfter statistischer Kennzahlen ohne Emotionen.",
  guru_match_reason_category_macro: "Steuert Portfolios vorausschauend durch globale Zins- und Liquiditätszyklen.",
  guru_match_reason_category_hedge: "Asymmetrische Absicherung gegen Systemkrisen und Markteinbrüche.",
  ...
  settings_target_section_desc: "Legen Sie die Zielallokation nach Anlagekategorien fest. Die Summe muss 100% betragen.",
  settings_target_sum: (n) => `Gesamt: ${n}%`,
  settings_target_save: "Speichern",
  settings_target_saved: "Gespeichert",
  settings_data_title: "Daten-Backup & Verwaltung",
  settings_data_local_auto_note:
    "Alle Portfoliodaten werden automatisch in Echtzeit im lokalen Speicher (localStorage) Ihres Browsers gespeichert.",
  settings_data_local_title: "Lokalen Speicher zurücksetzen",
  settings_data_desc:
  ...
  profile_notes_label: "Besonderheiten / Hinweise",
  profile_notes_placeholder:
    "z. B. Hypothek: noch 230.000 € (15 Jahre). 500 €/Monat werden automatisch in S&P-500-ETF investiert, aktiv verwaltetes Budget: 300 €.",
  ...
  at_filter_all_account: "Alle Konten",
  ...
  history_range_6m: "6M",
  history_range_1y: "1J",
  history_range_all: "ALLE",
  history_all_portfolio_badge: "Basis: Gesamtes Portfolio",
  ...
  pnl_sort_abs: "Nach Betrag",
  pnl_sort_profit: "Nach Gewinn",
  pnl_sort_return: "Nach Rendite",
  pnl_show_top20: "Top 20",
  pnl_show_all: (count) => `Alle (${count})`,
  pnl_summary_win_loss: (win, loss) => `Gewinn ${win} · Verlust ${loss}`,
  ...
  broker_type_none: "Keine (Nicht angegeben)",
  broker_type_custom: "Benutzerdefiniert...",
  broker_type_custom_placeholder: "Kontotyp manuell eingeben",
  ...
  broker_delete_inline_confirm: "Möchten Sie dieses Depot wirklich löschen?",
  broker_confirm_btn: "Bestätigen",
  ...
  fire_kpi_target_amount: "Zielvermögen",
  fire_kpi_total_contributions: "Gesamteinzahlungen",
  fire_kpi_compound_growth: "Zinseszinseffekt",
  fire_kpi_years_to_fire: "FIRE-Meilenstein",
  fire_kpi_already_achieved: "Ziel erreicht 🎉",
  fire_preset_conservative: "Konservativ (4%)",
  fire_preset_moderate: "Moderat (7%)",
  fire_preset_aggressive: "Aggressiv (10%)",
  fire_kpi_compound_leverage: "Zinseszins-Hebelwirkung",
  fire_kpi_compound_ratio: (ratio) => `+${ratio}% Zinseszinsgewinn`,
  fire_kpi_years_suffix: (years) => `In ${years} J.`,
  fire_age_reached_badge: (age) => `Mit ${age} J.`,
  fire_already_reached_desc: "Ihr aktuelles Portfolio übersteigt bereits Ihr Ziel. Sie können die finanzielle Freiheit ab sofort genießen.",
  fire_age_unit: "J.",
  fire_swr_preset_conservative: "3.5% (Konservativ)",
  fire_swr_preset_trinity: "4.0% (Trinity-Regel)",
  fire_swr_preset_aggressive: "5.0% (Aggressiv)",
  ...
  fire_chart_milestone: "FIRE-Meilenstein",
