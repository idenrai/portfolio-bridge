...
export const de: Translations = {
  ...
  custom_guru_target_preview_label: "Verknüpfte Ziel-Allokation (aus Einstellungen)",
  custom_guru_target_empty: "Keine Ziel-Allokation festgelegt. [In Einstellungen festlegen]",
