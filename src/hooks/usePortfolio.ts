...
export function usePortfolio() {
  ...
  const insightMessages = useMemo(() => ({
    concentration: (name: string, pct: string) => t.insight_concentration(name, pct),
    ...
    fxHigh: (currency: string, pct: string) => t.insight_fx_high(currency, pct),
    tagOver: (label: string, pct: string, target: string, diff: string) => t.insight_tag_over(label, pct, target, diff),
    tagUnder: (label: string, pct: string, target: string, diff: string) => t.insight_tag_under(label, pct, target, diff),
