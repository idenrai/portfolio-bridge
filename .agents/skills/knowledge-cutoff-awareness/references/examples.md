...
Run the following commands from the **skill root directory** (e.g. `.agents/skills/knowledge-cutoff-awareness` or `skills/knowledge-cutoff-awareness`). The path `scripts/get_date.js` is relative to that directory.
