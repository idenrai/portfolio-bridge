...
> **Positioning:** `.agents/rules/senior-engineer-conduct.md`의 원칙을 프로젝트 구조의 **인덱싱 및 종속성 검색**에 구체화한 규칙입니다.
> 원칙적인 행동 규범은 `.agents/rules/senior-engineer-conduct.md`를 참조하세요. 이 규칙은 **구체적인 행동 절차**만을 정의합니다.
